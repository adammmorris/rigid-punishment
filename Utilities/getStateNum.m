%% getStateNum: takes in the last actions from both players & outputs the state number for both roles
% N.B. This assumes that agents represent being in the other person's turn.
